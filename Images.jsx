...
export class Images extends React.Component {
    ...
    loadImages(Id) {
        ...
        $.ajax({
            url: `${process.env.SERVICE_PROFILE}/profile/profile/getEmployerProfileImage/?id=` + Id,
            headers: {
            ...
            success: function (res) {
                ...
                if (res.employerProfile.length > 0) {
                    for (var i = 0; i < res.employerProfile.length; i++) {
                        imageSrcArr.push(`${process.env.SERVICE_PROFILE}/profile/profile/getEmployerProfileImage/?id=` + res.employerProfile[i].fileName);
    ...
    fileUploadHandler(Id) {
        ...
        $.ajax({
            url: `${process.env.SERVICE_PROFILE}/profile/profile/addEmployerProfileImages`,
            headers: {
                'Authorization': 'Bearer ' + cookies
            },
            type: "POST",
